...
\runningheadrule
\firstpageheader{ИнтМатПак}{MATLAB 3}{17 марта 2026}
...
\part[1]
Постройте график $\dot{x}(t)$ и напишите код, который определяет максимум этой функции на интервале от 35 до 45 c для $a = 1$, $b = -0.25$, $c=1$, $m = 10$ и начальных условий $x(0)=1$, $\dot{x}(0)=0$:
\fillwithdottedlines{4cm}

\renewcommand\partlabel{в)}
\part[1]
Чему равно значение локального максимума функции $\dot{x}(t)$ на интервале от 35 до 45 с? Ответ запишите с точностью до 4 значащих цифр.
\answerline[0.1215]

\renewcommand\partlabel{г)}
\part[1]
Постройте фазовый портрет $(x,\dot{x})$ для $t \in [0,100]$. Чему равно расстояние от точки $[x(t_1),\dot{x}(t_1)]$ до начала координат фазовой плоскости при $t_1=10$ c? Ответ запишите с точностью до 4 значащих цифр.
\answerline[0.5111]
